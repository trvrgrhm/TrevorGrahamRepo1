...
namespace RpsGame_Refactored
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Player p1 = gameContext.CreatePlayer("Max","Headroom");
            ...
            {//Menu to log in or quit. start loop for logged in player. exits when he logs out
                ...
                Player p2 = gameContext.CreatePlayer(userNamesArray[0],userNamesArray[1]);//players.Where(x => x.Fname == userNamesArray[0] && x.Lname == userNamesArray[1]).FirstOrDefault();
